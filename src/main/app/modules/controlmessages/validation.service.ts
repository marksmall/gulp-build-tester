 ...
 */
 export class ValidationService {
   ...
   *
   * We attach this validator to the Control Group rather than a control with
   * two email controls with input that we require matching. The error message is attached to repeat email control.
   *
